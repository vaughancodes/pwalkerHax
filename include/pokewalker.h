...
typedef struct {
	...
	u16 moves[4];
	u8 level;
	u8 variants;	// 0x20 mask = female, first 5 bits = form
	u8 flags;		// 0x02 = shiny, 0x01 = has form
} pokemon_data;
